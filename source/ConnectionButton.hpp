...
public:
    ...
    void paintButton (juce::Graphics& g, bool shouldDrawButtonAsHighlighted, bool shouldDrawButtonAsDown) override
    {
        ...
        g.strokePath (isConnected ? connected : disconnected, juce::PathStrokeType (shouldDrawButtonAsHighlighted ? 1.3f : 1.1f), connected.getTransformToScaleToFit (graphicBounds, false));
    }
